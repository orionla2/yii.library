...
class ProductSelectController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['ProductSelect'];
			if($model->save())
	 ...
	 * @return ProductSelect the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ProductSelect::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ProductSelect $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='product-select-form')
		{

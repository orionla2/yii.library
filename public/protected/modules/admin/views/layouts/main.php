...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/drop/style.css">
	<!--[if lt IE 8]>
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/dropZone/jquery.fileupload.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/dropZone/jquery.iframe-transport.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/dropZone/jquery.knob.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/dropZone/jquery.ui.widget.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/dropZone/myDropZone.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/dropZone/services.js"></script>
